...
MODEL                := Final_Project
MODULES              := Final_Project_data.c Final_Project_tgtconn.c rtGetInf.c rtGetNaN.c rt_matrx.c rt_nonfinite.c rt_printf.c rt_zcfcn.c 
MAKEFILE             := Final_Project.mk
MATLAB_ROOT          := C:/PROGRA~1/MATLAB/R2016b
MATLAB_BIN           := C:/PROGRA~1/MATLAB/R2016b/bin
S_FUNCTIONS          := sf_rtsync.c sfc_clm.cpp
S_FUNCTIONS_LIB      := 
SOLVER               := 
NUMST                := 2
TID01EQ              := 1
NCSTATES             := 2
BUILDARGS            :=  EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 TMW_EXTMODE_TESTING=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTGTCONN -DON_TARGET_WAIT_FOR_START=0"
MULTITASKING         := 0
EXT_MODE             := 1
EXTMODE_TRANSPORT    := 0
...
#
MODELLIB                  := Final_Projectlib_sldrt.lib
MODELREF_LINK_LIBS        := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/GUOPIN~1/Desktop/!!FORS~1/FESBIC~1/Final_Project_sldrt_win64;C:/Users/GUOPIN~1/Desktop/!!FORS~1/FESBIC~1;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
%.obj : C:/Users/GUOPIN~1/Desktop/!!FORS~1/FESBIC~1/Matlab2012b_W32_64_Simulink_RehaStim1/simulink_rehastim1/%.c $(MAKEFILE)
	$(call BUILDOBJ, $(CC))
...
%.obj : C:/Users/GUOPIN~1/Desktop/!!FORS~1/FESBIC~1/Matlab2012b_W32_64_Simulink_RehaStim1/simulink_rehastim1/%.cpp $(MAKEFILE)
	$(call BUILDOBJ, $(CPP))

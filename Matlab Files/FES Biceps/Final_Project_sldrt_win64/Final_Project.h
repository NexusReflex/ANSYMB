...
#define Final_Project_rtModel          RT_MODEL_Final_Project_T

/* Block signals (auto storage) */
typedef struct {
  real_T DataTypeConversion2[6];       /* '<Root>/Data Type Conversion2' */
  real_T Divide[6];                    /* '<Root>/Divide' */
  real_T Sum2;                         /* '<Root>/Sum2' */
  real_T Abs;                          /* '<Root>/Abs' */
  real_T Angle;                        /* '<Root>/Angle' */
  real_T ArmAngle;                     /* '<Root>/Filter' */
  real_T Sum;                          /* '<Root>/Sum' */
  real_T Integrator;                   /* '<Root>/Integrator' */
  real_T ControlSwitch;                /* '<Root>/Control Switch' */
  real_T Current;                      /* '<Root>/Current' */
  real_T I;                            /* '<Root>/I' */
  real_T stimmode;                     /* '<Root>/stim mode' */
  real_T SFunction;                    /* '<S1>/S-Function' */
  real_T SFunction_e;                  /* '<S2>/S-Function' */
  real_T Vorsteuerung;                 /* '<Root>/Vorsteuerung' */
  real_T P;                            /* '<Root>/P' */
  real_T Sum1;                         /* '<Root>/Sum1' */
  real_T curPulse;                     /* '<Root>/curPulse' */
  real_T Quantizer;                    /* '<Root>/Quantizer' */
  real_T Saturation;                   /* '<Root>/Saturation' */
  int32_T PacketOutput;                /* '<Root>/Packet Output' */
  int32_T PacketInput_o2;              /* '<Root>/Packet Input' */
  int16_T PacketInput_o1[6];           /* '<Root>/Packet Input' */
  uint8_T DataTypeConversion;          /* '<Root>/Data Type Conversion' */
} B_Final_Project_T;

/* Block states (auto storage) for system '<Root>' */
typedef struct {
  real_T SFunction_RWORK[3];           /* '<S2>/S-Function' */
...
#define rtB                            Final_Project_B
#define BlockIO                        B_Final_Project_T
#define rtX                            Final_Project_X
#define ContinuousStates               X_Final_Project_T
#define rtXdot                         Final_Project_XDot
#define StateDerivatives               XDot_Final_Project_T
#define tXdis                          Final_Project_XDis
#define StateDisabled                  XDis_Final_Project_T
#define rtP                            Final_Project_P
#define Parameters                     P_Final_Project_T
#define rtDWork                        Final_Project_DW
#define D_Work                         DW_Final_Project_T
#define rtPrevZCSigState               Final_Project_PrevZCX
#define PrevZCSigStates                PrevZCX_Final_Project_T
...
struct P_Final_Project_T_ {
  ...
  real_T P_Gain;                       /* Expression: 2
                                        ...
                                        */
  real_T curPulse_Gain;                /* Expression: 1
                                        * Referenced by: '<Root>/curPulse'
                                        */
  real_T Quantizer_Interval;           /* Expression: 10
  ...
  real_T Constant1_Value;              /* Expression: 10
                                        ...
                                        */
  real_T Umrechnung_Value;             /* Expression: 90
                                        * Referenced by: '<Root>/Umrechnung'
                                        */
  real_T Angle_Gain;                   /* Expression: 1
                                        * Referenced by: '<Root>/Angle'
                                        */
  real_T Sollwert_Value;               /* Expression: 45
  ...
  real_T Filter_C;                     /* Computed Parameter: Filter_C
                                        * Referenced by: '<Root>/Filter'
                                        */
  real_T ControlActive_Value;          /* Expression: 10
  ...
  real_T Off_Value;                    /* Expression: 0
                                        ...
                                        */
  real_T ControlSwitch_Threshold;      /* Expression: 1
                                        * Referenced by: '<Root>/Control Switch'
                                        */
  real_T Current_Value;                /* Expression: 15
                                        * Referenced by: '<Root>/Current'
                                        */
  real_T I_Gain;                       /* Expression: 2
                                        * Referenced by: '<Root>/I'
                                        */
  real_T stimmode_Value;               /* Expression: 1
  ...
  real_T SFunction_P2_Size_m[2];       /* Computed Parameter: SFunction_P2_Size_m
                                        * Referenced by: '<S2>/S-Function'
                                        */
  real_T SFunction_P2_k;               /* Expression: strict
                                        * Referenced by: '<S2>/S-Function'
                                        */
};
...
/* Continuous states (auto storage) */
extern X_Final_Project_T Final_Project_X;
...
/* Zero-crossing (trigger) state */
extern PrevZCX_Final_Project_T Final_Project_PrevZCX;

/* Model entry point functions */
extern void Final_Project_initialize(void);
extern void Final_Project_output(void);
extern void Final_Project_update(void);
extern void Final_Project_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern Final_Project_rtModel *Final_Project(void);
 ...
 *
 * '<Root>' : 'Final_Project'
 * '<S1>'   : 'Final_Project/Stimulator Interface'
 * '<S2>'   : 'Final_Project/rt_sync'
 */
